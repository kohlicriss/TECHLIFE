    ...
    projects: [
      {
        ...
        description: 'Developed a responsive employee directory with search and filter capabilities',
    ...
    projects: [
      {
        ...
        description: 'Created an inventory tracking system with barcode scanning',
...
const filters = [
  { 
    name: 'Role', 
    options: ['Select Role', 'Associate Software Engineer', 'Frontend Developer', 'Backend Developer', 'Data Analyst', 'QA Engineer', 'DevOps Engineer', 'Product Manager']
  },
  { 
    name: 'Department', 
    options: ['Select Department', 'Software Development', 'UI/UX Design', 'Software Engineering', 'Data Science', 'Quality Assurance', 'Cloud Infrastructure', 'Product Management'] 
  },
  { 
    name: 'Location', 
    options: ['Select Location', 'ANASOL CONSULTANCY SERVICES PRIVATE LIMITED', 'TechNova Solutions Pvt. Ltd.', 'Remote'] 
  }
];
...
function EmployeeApp() {
  ...
  const [selectedFilters, setSelectedFilters] = useState(
    filters.reduce((acc, filter) => ({ ...acc, [filter.name]: filter.options[0] }), {})
  );
          ...
          {filters.map((filter, index) => (
            ...
            >
              <select
                ...
                onChange={(e) => setSelectedFilters({ ...selectedFilters, [filter.name]: e.target.value })}
              >
              ...
              <div className="px-6 py-6">                
                <div className="flex flex-col items-center text-center">                  
                  ...
                  <div className="min-w-0 mb-6">
                    ...
                    <p className="text-sm font-medium text-indigo-500 truncate">{employee.role}</p>
                  </div>
                </div>
