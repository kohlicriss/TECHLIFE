               ...
               <span className="truncate text-xs min-w-0" title={employee.workEmail || 'N/A'}>
                   {employee.workEmail || 'N/A'}
                                                ...
                                                <div className="flex flex-col items-center justify-center h-full space-y-2 sm:space-y-3 p-4 sm:p-5">
                                                    ...
                                                    <div className="space-y-1 sm:space-y-2 w-full max-w-xs">
                                                        <button
                                                            ...
                                                            className={`px-6 sm:px-8 py-2 sm:py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-bold rounded-lg sm:rounded-xl hover:shadow-lg transform hover:scale-105 transition-all duration-200 focus:ring-4 focus:ring-blue-500/30 text-xs sm:text-sm w-full flex items-center space-x-2`}
                                                        >
                                                        ...
                                                        {matchedArray.includes("GET_PUBLIC") && (
                                                            <button
                                                                ...
                                                                className={`px-6 sm:px-8 py-2 sm:py-3 bg-gradient-to-r from-green-500 to-teal-600 text-white font-bold rounded-lg sm:rounded-xl hover:shadow-lg transform hover:scale-105 transition-all duration-200 focus:ring-4 focus:ring-green-500/30 text-xs sm:text-sm w-full flex items-center space-x-2`}
                                                            >
                                                        ...
                                                        { matchedArray && matchedArray.includes("EMPLOYEE_VIEW_DOCS") &&
                                                            <button
                                                                ...
                                                                className={`px-6 sm:px-8 py-2 sm:py-3 bg-gradient-to-r from-purple-500 to-purple-600 text-white font-bold rounded-lg sm:rounded-xl hover:shadow-lg transform hover:scale-105 transition-all duration-200 focus:ring-4 focus:ring-purple-500/30 text-xs sm:text-sm w-full flex items-center space-x-2`}
                                                            >
                                                        ...
                                                        { matchedArray && matchedArray.includes("VIEW_TEAM") &&
                                                            <button
                                                                ...
                                                                className={`px-6 sm:px-8 py-2 sm:py-3 bg-gradient-to-r from-teal-500 to-teal-600 text-white font-bold rounded-lg sm:rounded-xl hover:shadow-lg transform hover:scale-105 transition-all duration-200 focus:ring-4 focus:ring-teal-500/30 text-xs sm:text-sm w-full flex items-center space-x-2`}
                                                            >
                                        ...
                                        <motion.div
                                            ...
                                            whileTap={{ scale: 0.98 }}
                                            className={`rounded-none sm:rounded-2xl md:rounded-3xl p-4 sm:p-6 md:p-8 shadow-lg border cursor-pointer group transition-all duration-300 hover:shadow-xl ${
                                                theme === 'dark'
                                                ...
                                                <div className="flex-1 min-w-0 z-10">
                                                    <div className="flex items-start justify-between">
                                                        <div className="min-w-0 flex-1">
                                                            ...
                                                            <p className="text-blue-600 font-semibold mb-2 sm:mb-3 text-xs bg-blue-100 dark:bg-blue-900/30 px-2 py-1 rounded-full w-fit">
