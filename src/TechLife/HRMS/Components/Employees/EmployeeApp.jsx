    ...
    const renderField = (label, name, type = "text", required = false, options = []) => {
        ...
        return (
            <div className="group relative" key={name}>
                <label className={`block text-sm font-semibold mb-2 flex items-center ${theme === 'dark' ? 'text-gray-200' : 'text-gray-800'
                    }`}>
                    {label}
        ...
        return (
            <div className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-center justify-center z-[200] p-4 animate-fadeIn">
                <motion.div
                    ...
                    className={`relative w-full max-w-5xl max-h-[90vh] overflow-hidden shadow-2xl rounded-2xl ${theme === 'dark' ? 'bg-gray-800 text-white' : 'bg-white text-gray-900'
                        }`}
                >
                    ...
                    <div className="overflow-y-auto max-h-[calc(90vh-140px)]">
                        <form className="p-6" onSubmit={handleFormSubmit}>
                            ...
                            {errors.general && (
                                <div className={`mt-4 p-4 border-l-4 border-red-400 rounded-r-lg animate-slideIn ${theme === 'dark' ? 'bg-red-900/20' : 'bg-red-50'
                                    }`}>
                    ...
                    <div className={`px-6 py-4 border-t flex justify-end space-x-3 ${theme === 'dark'
                        ...
                        <button
                            ...
                            className={`px-6 py-2.5 border-2 rounded-lg font-semibold text-sm transition-all duration-200 focus:ring-4 focus:ring-gray-500/20 ${theme === 'dark'
        ...
        <div className={`min-h-screen ${theme === 'dark'
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <motion.div
                    ...
                    className={`rounded-xl p-6 shadow-lg border mb-8 ${theme === 'dark'
                    ...
                    <div className="mb-4">
                        <div className="relative group max-w-md">
                            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <IoSearchOutline className={`h-5 w-5 ${theme === 'dark' ? 'text-gray-400' : 'text-gray-400'
                                    }`} />
                            </div>
                            <input
                                type="text"
                                className={`w-full pl-10 pr-4 py-3 border-2 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 focus:outline-none transition-all duration-300 placeholder-gray-500 text-sm ${theme === 'dark'
                    ...
                    <div className="flex flex-wrap gap-3 items-center justify-between">
                            ...
                            {dynamicFilters.map((filter) => {
                                ...
                                return (
                                    <div key={filter.name} className="relative group">
                                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                            <IconComponent className={`h-4 w-4 ${theme === 'dark' ? 'text-gray-400' : 'text-gray-400'
                                                }`} />
                                        </div>
                                        <select
                                            className={`pl-9 pr-8 py-2.5 border-2 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 focus:outline-none transition-all duration-300 appearance-none cursor-pointer min-w-[140px] text-sm ${theme === 'dark'
                                                ? 'bg-gray-700 border-gray-600 text-white hover:border-gray-500 group-hover:border-blue-400'
                                        ...
                                        <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                            <IoChevronDownOutline className={`h-4 w-4 ${theme === 'dark' ? 'text-gray-400' : 'text-gray-400'
                                                }`} />
                                        </div>
                                    </div>
                                );
                        ...
                        <div className="flex gap-2">
                            <button
                                ...
                                className={`flex items-center space-x-2 px-4 py-2.5 border-2 rounded-lg font-semibold text-sm transition-all duration-200 ${theme === 'dark'
                ...
                {filteredEmployees.length > 0 ? (
                            ...
                            {filteredEmployees.map((employee, index) => (
                                ...
                                >
                                    {viewMode === 'grid' ? (
                                        ...
                                        <div
                                            className={`relative w-full h-80 cursor-pointer transition-transform duration-700 preserve-3d ${flippedCard === employee.employeeId ? 'rotate-y-180' : ''
                                                }`}
                                        ...
                                        >
                                            {/* FRONT SIDE */}
                                            <div
                                                className={`absolute inset-0 w-full h-full rounded-xl shadow-lg border cursor-pointer group backface-hidden transform-gpu transition-all duration-300 hover:shadow-xl ${theme === 'dark'
                                            ...
                                            >
                                                <div className="flex flex-col items-center text-center h-full justify-center p-5 relative overflow-hidden">
                                                    ...
                                                    <div className="absolute top-0 right-0 w-24 h-24 opacity-10">
                                                        <div className={`w-full h-full rounded-full ${theme === 'dark' ? 'bg-blue-400' : 'bg-blue-500'
                                                    ...
                                                    <div className="w-full z-10">
                                                        ...
                                                        <div className="space-y-2 text-xs">
                                                            {/* Employee ID */}
                                                            <div className={`flex items-center justify-center space-x-2 p-2 rounded-md ${theme === 'dark' ? 'bg-gray-700/50 text-gray-300' : 'bg-gray-100/50 text-gray-600'
                                                                }`}>
                                            ...
                                            {/* BACK SIDE */}
                                            <div
                                                className={`absolute inset-0 w-full h-full rounded-xl shadow-lg border backface-hidden rotate-y-180 ${theme === 'dark'
                                                ...
                                                <div className="flex flex-col items-center justify-center h-full space-y-3 p-5">
                                                    ...
                                                    <div className="space-y-2 w-full max-w-xs">
                                                        <button
                                                            ...
                                                            className={`w-full flex items-center space-x-2 px-3 py-2.5 rounded-lg transition-all duration-300 transform hover:scale-105 text-sm ${theme === 'dark'
                                        ...
                                        <motion.div
                                            ...
                                            whileTap={{ scale: 0.98 }}
                                            className={`w-full rounded-xl shadow-lg border cursor-pointer group transition-all duration-300 hover:shadow-xl ${theme === 'dark'
                                                ...
                                                <div className="flex-1 min-w-0 z-10">
                                                    <div className="flex items-start justify-between">
                                                        <div className="min-w-0 flex-1">
                                                            <h3 className={`text-lg font-bold truncate mb-1 ${theme === 'dark' ? 'text-white' : 'text-gray-900'
                                                                }`}>
                                                                {employee.displayName}
                                                            </h3>
                                                            ...
                                                            <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-xs">
                                                                {/* Employee ID */}
                                                                <div className={`flex items-center space-x-1 p-2 rounded-md ${theme === 'dark' ? 'bg-gray-700/50 text-gray-300' : 'bg-gray-100 text-gray-600'
                                                                    }`}>
                                                                    <IoIdCardOutline className={`w-3 h-3 ${theme === 'dark' ? 'text-orange-400' : 'text-orange-500'
                                                                        }`} />
                                                                    <span className="truncate font-mono text-xs">{employee.employeeId}</span>
                                                        ...
                                                        <div className="flex items-center space-x-2 ml-4">
                                                            <button
                                                                ...
                                                                className={`p-2 rounded-lg transition-all duration-200 transform hover:scale-110 ${theme === 'dark'
                    ...
                    <div className="text-center py-16">
                        <div className={`w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4 ${theme === 'dark' ? 'bg-gray-700' : 'bg-gray-100'
                            }`}>
                            <IoPersonOutline className={`w-10 h-10 ${theme === 'dark' ? 'text-gray-400' : 'text-gray-400'
                                }`} />
                        </div>
                        <h2 className={`text-xl font-bold mb-2 ${theme === 'dark' ? 'text-white' : 'text-gray-800'
                ...
                <div className="flex justify-between items-center mt-8">
                    <button
                        ...
                        className={`flex items-center space-x-2 px-5 py-2.5 rounded-lg font-semibold text-sm transition-all duration-200 ${theme === 'dark'
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <select
                            ...
                            className={`px-3 py-2 border rounded-lg text-sm ${theme === 'dark' ? 'bg-gray-700 text-white border-gray-600' : 'bg-gray-100 text-gray-800 border-gray-300'
                                }`}
                        >
            ...
            <AnimatePresence>
                {contextMenu.visible && (
                    <motion.div
                        ...
                        className={`fixed z-50 border-2 rounded-lg shadow-2xl py-2 min-w-[140px] ${theme === 'dark'
                    ...
                    >
                        <button
                            ...
                            className={`w-full text-left px-4 py-2.5 text-sm transition-colors flex items-center space-x-2 ${theme === 'dark'
