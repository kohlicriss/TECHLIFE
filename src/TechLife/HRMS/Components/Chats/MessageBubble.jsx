...
function MessageBubble({
  ...
  return (
    ...
    >
      ...
      <div
        className={`max-w-xs md:max-w-md px-2.5 py-1 rounded-lg ${
          isMe ? "bg-green-700 text-white" : "bg-gray-200 text-black"
        }`}
      >
        {msg.isForwarded && (
          <p
            className={`text-xs italic mb-1 ${
              isMe ? "text-gray-200" : "text-gray-600"
            }`}
          >
            Forwarded
          </p>
        ...
        {msg.replyTo && (
          <div
            className={`mb-1 border-l-4 ${
              isMe ? "border-blue-300" : "border-blue-500"
            } pl-2 text-xs ${
              isMe ? "text-white bg-green-900" : "text-black bg-gray-300"
            } rounded`}
          >
        ...
        {msg.type === "system" && (
          <p className="italic text-gray-600 text-xs text-center">{msg.text}</p>
        )}
        ...
        {msg.type === "image" &&
          (!fileDownloaded && !isMe ? (
            <button
              ...
              className="bg-white text-green-800 font-semibold hover:bg-gray-200 mt-2 text-xs px-2 py-1 rounded"
            >
              Download Image
            </button>
          ) : (
            <div
              ...
              className="bg-green-800 p-1 rounded-lg max-w-xs shadow cursor-pointer"
            >
              <img
                src={msg.url}
                alt="sent-img"
        ...
        {msg.type === "file" &&
          (!fileDownloaded && !isMe ? (
            <div className="bg-green-800 text-white w-56 h-[100px] rounded-xl p-2 shadow-md flex flex-col justify-between">
              <div className="flex gap-2 items-start">
                ...
                <div className="flex flex-col flex-1 justify-between h-full overflow-hidden">
                  <div>
                    <p className="text-xs font-bold truncate whitespace-nowrap overflow-hidden max-w-[130px]">
                      {msg.filename}
                    </p>
              ...
              <button
                onClick={() => setFileDownloaded(true)}
                className="bg-white text-green-800 font-semibold hover:bg-gray-200 mt-2 text-xs px-3 py-0.5 rounded w-full"
              >
                Download File
              </button>
            </div>
          ) : (
            <div className="bg-green-800 text-white w-56 h-[100px] rounded-xl p-2 shadow-md">
                ...
                <div className="flex flex-col flex-1 justify-between h-full overflow-hidden">
                  ...
                  <div className="flex justify-between gap-2">
                    <button
                      ...
                      className="bg-white text-green-800 font-semibold hover:bg-gray-200 px-2 py-0.5 rounded text-xs w-20"
                    >
                      Open
                    </button>
                    <button
        ...
        {msg.type === "audio" && (
          <audio controls src={msg.url} className="mt-1 h-7 w-52">
      ...
      {showMenu && (
        <div
          className={`absolute z-50 w-44 bg-white border shadow-md rounded-md ${
            isMe ? "right-0" : "left-0"
        ...
        >
          ...
          {isMe && !isDeleted && (
            <p
              className="text-sm px-4 py-2 hover:bg-gray-100 cursor-pointer"
              onClick={() => handleMenuAction("deleteForEveryone")}
            >
              Delete for everyone
            </p>
          )}
      ...
      {showSaveModal && fileToHandle && (
        ...
        >
          <div
            className="bg-white w-[300px] p-4 rounded shadow-xl"
