...
const Calendar = ({ selectedDate, onSelectDate, onClose }) => {
  ...
  return (
    <div className="absolute z-10 bg-white shadow-lg rounded-lg p-2 mt-36 mr-20 border border-gray-300">
      <div className="flex justify-between items-center mb-2">
        ...
        <div className="flex-1 flex justify-center space-x-2">
          <button
            ...
            className="font-semibold px-1 py-1 rounded-md hover:bg-gray-100"
          >
      ...
      {showSelector === "calendar" && (
        <>
          <div className="grid grid-cols-7 gap-1 text-sm font-small text-center text-gray-500">
            <div>Su</div>
            <div>Mo</div>
            <div>Tu</div>
            <div>We</div>
