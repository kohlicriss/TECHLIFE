                    ...
                    <Routes>
                        {!isAuthenticated ? (
                            ...
                            >
                                ...
                                <Route path="/employees/:empID/public/:employeeID" element={<ProtectedRoute><EmployeeProfile /></ProtectedRoute>} />
                                ...
                                <Route path="/permissions/:empID/*" element={<ProtectedRoute allowedRoles={['ADMIN']}><Permissions /></ProtectedRoute>} />
