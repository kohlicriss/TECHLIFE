...
export const tasksApi = createAxiosInstance('http://192.168.0.112:8090/api/employee');
export const publicinfoApi = createAxiosInstance('http://192.168.0.112:8090/api');
