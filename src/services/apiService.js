...
// ======================= FORWARD MESSAGE FUNCTIONALITY START =======================
/**
 * Forwards a message to multiple recipients (users or groups).
 * @param {Object} forwardData - The data required for forwarding.
 * @param {string} forwardData.sender - The ID of the user who is forwarding.
 * @param {number} forwardData.forwardMessageId - The ID of the message to forward.
 * @param {Array<Object>} forwardData.forwardTo - A list of targets. Each target is an object like { receiver: 'userId' } or { groupId: 'teamId' }.
 */
...
// ======================= FORWARD MESSAGE FUNCTIONALITY END =========================